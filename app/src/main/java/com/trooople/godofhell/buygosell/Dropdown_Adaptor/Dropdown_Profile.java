...
public class Dropdown_Profile extends BaseAdapter {
    private LayoutInflater layoutInflater;
    private List<Dropdown_model> listData;
    private Context context;
    public Dropdown_Profile(Context context, List<Dropdown_model> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = layoutInflater.inflate(R.layout.dropdown_profile, parent, false);
