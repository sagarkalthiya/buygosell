...
public class Dropdown_light_adaptor extends BaseAdapter {
    private LayoutInflater layoutInflater;
    private List<Dropdown_model> listData;
    private Context context;
    public Dropdown_light_adaptor(Context context, List<Dropdown_model> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = layoutInflater.inflate(R.layout.dropdown_light, parent, false);
            spinnerHolder.spinnerItemList = (TextView)convertView.findViewById(R.id.lightdroptextv);
            spinnerHolder.country_id = (TextView)convertView.findViewById(R.id.country_id_light);
            spinnerHolder.phonecode = (TextView)convertView.findViewById(R.id.phone_code_light);
            spinnerHolder.short_name = (TextView)convertView.findViewById(R.id.shortname_light);
