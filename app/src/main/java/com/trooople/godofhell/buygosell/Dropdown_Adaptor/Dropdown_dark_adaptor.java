...
public class Dropdown_dark_adaptor extends BaseAdapter {
    private LayoutInflater layoutInflater;
    private List<Dropdown_model> listData;
    private Context context;
    public Dropdown_dark_adaptor(Context context, List<Dropdown_model> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = layoutInflater.inflate(R.layout.dropdown_dark, parent, false);
            spinnerHolder.spinnerItemList = (TextView)convertView.findViewById(R.id.darkdroptextv);
